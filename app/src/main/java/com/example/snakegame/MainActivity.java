...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    // snakemoving position. Values must be right, left, top, bottom.
    ...
    // you can change this value to make bigger snake size
    ...
    // snake moving speed. value must be lie between 1 - 100
    ...
    // canvas to show snake and show on surface view
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // check if previous moving position in not bottom. Snake cant move.
                // For example if snake moving to bottom then snake cant directly start moving to the top
                // snake must take a right or left first then top
    ...
    private void addPoint(){
        ...
        // check if randomXPosition is even or an odd value. We need an even number only
    ...
    private void moveSnake(){
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                // check which side snake is moving
                switch (movingPosition)
                {
                    case "right":

                        // move snake's head to the right.
                    ...
                    case "bottom":
                        // move snake's head to the bottom.
                        // other points follow snake's head point to move the snake
                        snakePointsList.get(0).setPositionX(headPositionX);
                        snakePointsList.get(0).setPositionY(headPositionY + (pointSize * 2));
                        break;
                ...
                // check if game over. Weather snake touches the egdes or itself
                ...
                else
                {
                    ...
                    // changes snake's head position, other snake points will follow snakes head
                    ...
                    // other points following snakes head. Position 0 is the head of the snake
                    for(int i = 1; i < snakePointsList.size(); i++)
                    {
                        int getTempPositionX = snakePointsList.get(i).getPositionX();
                        int getTempPositionY = snakePointsList.get(i).getPositionY();

                        // moves points across the head
    ...
    private boolean checkGameOver(int headPositionX, int headPostionY)
    {
        boolean gameOver = false;

        // check if the snakes head touches the edges
        ...
        {
            //check if snakes head touches the snake itself
            for(int i = 0; i < snakePointsList.size(); i++)
            {
                if(headPositionX == snakePointsList.get(i).getPositionX() &&
                        headPostionY == snakePointsList.get(i).getPositionY())
                {
                    gameOver = true;
                    break;
                }
    ...
    {
        // to check if color is not defined before
        if(pointColor == null)
        {
